...
SELECT c.interaction_id,
       ...
       CASE WHEN nullif(c.client_code, '') IS NULL THEN 0::smallint ELSE 1::smallint END AS interaction_count,
...
SELECT task_id, task_code, task_description, created_at,
       ...
       resolution_days, feedback_topic_id, feedback_topic_name, feedback_theme,
       club_id, club_name, funnel_id, funnel_name, department_id, department_name,
       status_id, status_name, state_id, state_name, executor_id, executor_name,
       position_id, position_name, client_id, client_code, client_name, client_phone,
