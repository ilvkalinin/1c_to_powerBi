...
`9c46cdc6847ec69617a1abf8eaa5cd0635777109d58ea162558391991bb1242f`). SQL и объект витрины не
...
PBIT подтверждает отдельный current scope страницы «Отработка обратной
связи»: все interactions `Reference67` type «Обратная связь», созданные с
2025-01-01 до текущей даты, без `Jivo` в имени interaction. Фиксированного
фильтра тем, воронок или кампаний нет: сохранённые значения — состояние
слайсеров, а не правило source набора.
