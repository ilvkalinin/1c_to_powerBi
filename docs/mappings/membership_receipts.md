...
| `club_access_type` | сетевой/локальный | `Reference59`, `InfoRg8595` | `Fld697`, `Fld8603/8597...` | product override then contract GUID | `text` | да | контракт | VALIDATED CURRENT-PBIT COVERAGE — SV-119; `InfoRg8595` uniqueness remains pending | DAX | MR-V10 |
