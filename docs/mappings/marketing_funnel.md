...
| `VALIDATION_PENDING` | когорты накопленного трафика | Exact current DAX/M отсутствует среди согласованных материалов. Архивный PBIT хранит вариант `UNION(Задания 2024, Задания 2025)` с двухмесячным окном, отменами и контрактами как potential artifact; не применять без решения. | MF-V08, MF-V09 |
