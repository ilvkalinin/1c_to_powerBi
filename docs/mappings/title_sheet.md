...
| `mart.client_base_daily` | ежедневная КБ для произвольной даты | Schema implemented / initial load not requested | ADR-0031; client base/work attendance mappings |
