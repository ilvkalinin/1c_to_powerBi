...
| Новички и гостевые визиты | NV-V02 | NV-V05 подтвердил 12 ACCUNIQ-кодов, `Fld7585`, 18 602 движений и current groups; NV-V09 подтвердил latest/state path, но сохранил 8 ties и 128 client-date duplicate excess. NV-V06 подтвердил exact PBIT predicate подходящего договора и границы outcome: 0/44 включаются, 45 исключается. Остаётся отсутствие размножения `AccumRg7575 → Document325/Reference59`. |
