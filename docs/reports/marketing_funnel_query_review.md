...
| `VALIDATION_PENDING` | В report funnel четыре непустых physical payment type, но их label mapping не подтверждён. | Не выбирать рекарринг по частоте или порядку значений. |
