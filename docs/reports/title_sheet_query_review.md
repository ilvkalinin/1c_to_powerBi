...
Статус: `COMPLETE / TECHNICAL VALIDATION COMPLETE`.
...
## Выполненный пакет read-only проверок

Выполнено 2026-08-11 в read-only `gymdb`; SQL и live-результаты — в
[`server_validation_2026-08-05.md`](../source_metadata/server_validation_2026-08-05.md),
SV-062—SV-064. Исполняемый набор сохранён в
[`validation_sql/title_sheet_2026-08-11.sql`](../source_metadata/validation_sql/title_sheet_2026-08-11.sql).
...
Внешние источники расходов, характеристик, КБ, Renew и оборудования остаются
в Power BI по решению пользователя и не входят в PostgreSQL-валидацию.
