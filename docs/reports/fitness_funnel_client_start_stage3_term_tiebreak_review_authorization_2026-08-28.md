...
Пользователь уточнил BR-048 в ходе пакета: после двух рангов применяется
`Fld670 ASC` (ранняя активация), а при полном равенстве — `contract_ref ASC`
как воспроизводимый технический представитель «любой без разницы».
