...
|---:|---|---|---|---|---|---|---|---|
| 1 | Фитнес | KPI Фитнеса | COMPLETE — `kpi_fitness` | COMPLETE — `kpi_fitness` | DESIGNED — ADR-0012 | COMPLETE — `kpi_fitness` | DEFERRED | DEFERRED — technical validation |
...
| 4 | Фитнес | Подготовка к продлению | COMPLETE — `preparation_renewal` | COMPLETE — `preparation_renewal` | DESIGNED — ADR-0013 | COMPLETE — `preparation_renewal` | DEFERRED | DEFERRED — technical validation |
| 5 | Фитнес | Воронка лиды фитнес | COMPLETE — `fitness_leads_funnel` | COMPLETE — `fitness_leads_funnel` | DESIGNED — ADR-0011 | COMPLETE — `fitness_leads_funnel` | DEFERRED | DEFERRED — technical validation |
| 6 | Фитнес | Загрузка сотрудников | COMPLETE — `employee_workload` | COMPLETE — `employee_workload` | DESIGNED — ADR-0014 | COMPLETE — `employee_workload` | DEFERRED | DEFERRED — technical validation |
| 7 | Фитнес | Контроль предварительной записи | COMPLETE — `prebooking_control` | COMPLETE — `prebooking_control` | DESIGNED — ADR-0015 | COMPLETE — `prebooking_control` | DEFERRED | DEFERRED — technical validation |
...
| 9 | Фитнес | Посещения Физкульт | COMPLETE | COMPLETE — `visits_fizkult` | DESIGNED — ADR-0003 | COMPLETE — `visits_fizkult` | DEFERRED | DEFERRED — technical validation |
