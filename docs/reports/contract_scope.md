...
| 20 | Гостеприимство | Новички и гостевые визиты | COMPLETE — `newcomer_guest_visits` | COMPLETE — `newcomer_guest_visits` | DESIGNED — ADR-0020 | COMPLETE — `newcomer_guest_visits` | DEFERRED | PARTIALLY VALIDATED — SV-087; Stage 3 deferred |
| 21 | Гостеприимство | Отчет по обращениям | COMPLETE — `calls_report` | COMPLETE — `calls_report` | DESIGNED — ADR-0016 | COMPLETE — `calls_report` | DEFERRED | PARTIALLY VALIDATED — SV-088; Stage 3 deferred |
| 22 | Гостеприимство | Отчет по посещаемости клиентов с долгами | COMPLETE — `visits_debt` | COMPLETE — `visits_debt` | DESIGNED — ADR-0021 | COMPLETE — `visits_debt` | DEFERRED | PARTIALLY VALIDATED — SV-089; Stage 3 deferred |
...
| 24 | Гостеприимство | Работа с посещаемостью | COMPLETE — `work_attendance` | COMPLETE — `work_attendance` | DESIGNED — ADR-0022 | COMPLETE — `work_attendance` | DEFERRED | PARTIALLY VALIDATED — SV-065, SV-067; Stage 3 deferred |
...
| 29 | Для правления | Выручка ДПФУ | COMPLETE | COMPLETE — `dpfu_revenue` | DESIGNED — ADR-0005/0012/0025 | COMPLETE — `dpfu_revenue` | PROGRAM ENTRY CONFIRMED — product admission pending | COMPLETE — SV-054—SV-057 |
...
Единый decision matrix о допустимости Stage-3 product packages и условиях
перехода: [stage_2_transition_readiness_2026-08-13.md](stage_2_transition_readiness_2026-08-13.md).
