...
| 22 | Гостеприимство | Отчет по посещаемости клиентов с долгами | COMPLETE — `visits_debt` | COMPLETE — `visits_debt` | COMPLETE — ADR-0021 | COMPLETE — `visits_debt` | Power BI unchanged | IMPLEMENTED — VD-LOAD-001; source/stage/target/rerun controls passed |
...
| 24 | Гостеприимство | Работа с посещаемостью | COMPLETE — `work_attendance` | COMPLETE — `work_attendance` | DESIGNED — ADR-0022 | COMPLETE — `work_attendance` | DEFERRED | VALIDATED source formation — SV-065, SV-067, SV-111/WA-V06C; Stage 3 deferred |
