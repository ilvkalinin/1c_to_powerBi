-- REVIEW ONLY — do not execute without a separate user approval.
...
-- Rollback after COMMIT: DROP TABLE mart.membership_contract_kpi_unit;
--                        DROP TABLE mart.membership_receipt_movement;
...
CREATE TABLE mart.membership_contract_kpi_unit (
    ...
    effective_duration_days         numeric NOT NULL,
    source_stage                    text,
    super_stage                     text    NOT NULL,
    payment_type                    text    NOT NULL,
    payment_source                  text,
    ...
    calculation_price               numeric NOT NULL,
