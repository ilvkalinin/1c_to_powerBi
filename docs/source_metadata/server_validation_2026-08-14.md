...
строку цены. Нельзя исключить 38 строк или назначить им нулевую сумму без
нового доказанного источника/правила; витрина `mart.children_package_sale`
заблокирована именно на этом покрытии.
